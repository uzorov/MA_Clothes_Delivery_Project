...
# keycloak_client_secret = "j4fb56DrZ56LYwY3h8byA7YBkwFAeKZM"
...
# home_page = f"http://{host_ip}:80/order"
...
#     logging.info(request.session.get('prev_url'))
...
# def callback(request: Request, token: str = Depends(get_token)):
